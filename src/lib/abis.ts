...
export const GOVERNOR_ALPHA_ABI = [
  ...
  // --- Read (New: for on-chain state query) ---
  {
  ...
  },
  {
    ...
    outputs: [{ name: "", type: "uint8" }], // Returns 0~7 representing different states
    stateMutability: "view",
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      // Note: If Governor Bravo is upgraded, there may be an additional abstainVotes.
      // If the call fails, you can try commenting out this line, depending on your actual contract version.
